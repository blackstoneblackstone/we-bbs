...
$config['action_details'][notify_class::TYPE_REPORT_APPROVED] = array(
    'user_setting' => 1,
    'combine' => 1,
    'desc' => AWS_APP::lang()->_t('举报审核通过')
);

$config['action_details'][notify_class::TYPE_REPORT_REFUSED] = array(
    'user_setting' => 1,
    'combine' => 1,
    'desc' => AWS_APP::lang()->_t('举报审核拒绝')
);
