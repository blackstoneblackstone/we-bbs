...
class Zend_Cache_Backend_Memcached extends Zend_Cache_Backend implements Zend_Cache_Backend_ExtendedInterface
{
    ...
    public function __construct(array $options = array())
    {
        ...
        foreach ($this->_options['servers'] as $server) {
            $server['host'] = array_key_exists('host', $options) ? $options['host'] : $server['host'];
            $server['port'] = array_key_exists('port', $options) ? $options['port'] : $server['port'];
            $server['weight'] = array_key_exists('weight', $options) ? $options['weight'] : $server['weight'];
