...
define('ADDON_PATH',PUB_PATH.'plugins/');


// 定义 Cookies 前缀
define('G_COOKIE_PREFIX','kdm_');

// 定义应用加密 KEY
define('G_SECUKEY','hiqjvpagnurc');
define('G_COOKIE_HASH_KEY', 'hnavuciilbsoumv');
