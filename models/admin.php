...
class admin_class extends AWS_MODEL
{
    ...
    public function notifications_crond()
    {
        ...
        $admin_notifications = array(
                                // 内容审核
                                'answer_approval' => $this->count('approval', 'type = "answer" AND status = 0' ),
                                'question_approval' => $this->count('approval', 'type = "question" AND status = 0'),
                                'article_approval' => $this->count('approval', 'type = "article" AND status = 0'),
                                'article_comment_approval' => $this->count('approval', 'type = "article_comment" AND status = 0'),
