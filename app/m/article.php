...
class article extends AWS_MOBILE_CONTROLLER
{
    ...
    {
        // 文章前置钩子
        run_hook('article_detail_hook',['data'=>$_GET,'action'=>'before','platform'=>'mobile']);
        if (!is_mobile())
        {
        ...
        //文章后置钩子
        run_hook('article_detail_hook',['data'=>$_GET,'action'=>'after','article_info'=>$article_info,'platform'=>'mobile']);
