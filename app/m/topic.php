    ...
    public function index_action()
    {
        ...
        switch ($topic_info['model_type'])
        {
            default:
                ...
                TPL::assign('posts_list', $posts_list);
                TPL::assign('recommend_list_bit_count', !empty($posts_list) ? count($posts_list) : 0);
                ...
                TPL::assign('best_questions_list_bit_count', !empty($list) ? count($list) : 0);
                ...
                TPL::assign('all_questions_list_bit_count', !empty($posts_list) ? count($posts_list) : 0);
                ...
                TPL::assign('posts_list', $post_list);
                TPL::assign('articles_list_bit_count',!empty($posts_list) ? count($posts_list) : 0);
