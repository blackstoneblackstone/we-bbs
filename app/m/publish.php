...
class publish extends AWS_MOBILE_CONTROLLER
{
    ...
    public function index_action()
    {
        ...
        run_hook('publish_question_action_hook', ['question_info' => $question_info, 'platform' => 'mobile']); // 发起问题页面渲染钩子
    ...
    public function article_action()
    {
        ...
        run_hook('publish_article_action_hook',['article_info' => $article_info, 'platform' => 'mobile']); // 发起文章页面渲染钩子
