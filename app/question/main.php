...
class main extends AWS_CONTROLLER
{
	...
	public function index_action()
	{
		...
		{
            $question_info['attachs'] = $this->model('publish')->get_attach('question_attach', $question_info['question_id']);
		...
		$question_info['question_detail'] = nl2br(FORMAT::parse_imgs($question_info['question_detail']));
		...
		if (!$question_topics AND $this->user_id)
		{
        ...
        //问题后置钩子
        run_hook('question_detail_hook',['data'=>$_GET,'action'=>'after','question_info'=>$question_info]);
	...
	public function index_square_action()
	{
		...
		//钩子
        run_hook('action_question_main',['list'=>$question_list]);
