            ...
            else
            {
                if ($weibo_user)
                {
                    ...
                    else
                    {
                        ...
                        AWS_APP::session()->client_info['__CLIENT_UID'] = $user['uid'];
                        AWS_APP::session()->client_info['__CLIENT_USER_NAME'] = $user['user_name'];
                        AWS_APP::session()->client_info['__CLIENT_PASSWORD'] = $user['password'];
