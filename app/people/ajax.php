...
class ajax extends AWS_CONTROLLER
{
	...
	public function follows_action()
	{
		...
		{
			case 'follows':
				$users_list = $this->model('follow')->get_user_friends($_GET['uid'], $page,$this->per_page);
				if(is_mobile())
                {
			...
			case 'fans':
				$users_list = $this->model('follow')->get_user_fans($_GET['uid'], $page,$this->per_page);
