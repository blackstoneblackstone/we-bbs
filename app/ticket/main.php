...
class main extends AWS_CONTROLLER
{
    ...
    public function index_action()
    {
        ...
        if (!$this->user_info['permission']['is_administortar'] && !$this->user_info['permission']['is_service']
            && $ticket_info['uid'] != $this->user_id && !$this->model('ticket')->has_invited($ticket_info['id'],$this->user_id))
        {
