	...
	public function index_action()
	{
		...
		switch ($topic_info['model_type'])
		{
			default:
				...
				TPL::assign('all_list_bit_count', !empty($posts_list) ? sizeof($posts_list) : 0);
				...
				TPL::assign('posts_list', $posts_list);
				TPL::assign('recommend_list_bit_count', !empty($posts_list) ? sizeof($posts_list) : 0);
				...
				TPL::assign('best_questions_list_bit_count', !empty($list) ? sizeof($list) : 0);
				...
				TPL::assign('all_questions_list_bit_count', !empty($posts_list) ? sizeof($posts_list) : 0);
				...
				TPL::assign('posts_list', $post_list);
				TPL::assign('articles_list_bit_count', !empty($posts_list) ? sizeof($posts_list) : 0);
