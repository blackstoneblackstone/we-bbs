...
class ajax extends AWS_CONTROLLER
{
	...
	public function topic_info_action()
	{
		...
		$topic_info['topic_description'] = cjk_substr(strip_tags(htmlspecialchars_decode($topic_info['topic_description'])), 0, 80, 'UTF-8', '...');
	...
	public function edit_topic_action()
	{
        ...
        run_hook('edit_topic_action_hook', ['data' => $topic_info, 'action' => 'after']); // 编辑话题钩子
	...
	public function save_related_topic_action()
	{
        ...
        run_hook('save_related_topic_action_hook', ['topic_id' => $_GET['topic_id'], 'related_id' => $related_id, 'action' => 'after']); // 保存关联话题钩子
	...
	public function remove_action()
	{
        ...
        run_hook('remove_topic_action_hook', ['topic_id' => $_POST['topic_id'], 'action' => 'after']); // 删除话题钩子
