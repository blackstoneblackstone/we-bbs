...
class ajax extends AWS_CONTROLLER
{
	...
	{
        run_hook('remove_article_action_hook', ['id' => $_POST['article_id'], 'action' => 'before']); // 删除文章钩子
		...
		if ($article_info)
		{
            ...
            run_hook('remove_article_action_hook', ['article_info' => $article_info, 'action' => 'after']); // 删除文章钩子
		}
