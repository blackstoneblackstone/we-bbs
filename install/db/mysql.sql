...
/*新装用户自动安装编辑器*/
INSERT INTO `[#DB_PREFIX#]plugins` (`name`, `title`, `intro`, `author`, `version`, `state`, `config`) VALUES ('editor', '富文本/Markdown编辑器', '可随意切换编辑器为Markdown和富文本编辑器', 'WeCenter官方', '3.6.0', 1, '{\"type\":{\"title\":\"开启类型\",\"type\":\"radio\",\"value\":\"wangeditor\",\"options\":{\"wangeditor\":\"富文本编辑器\",\"markdown\":\"Markdown编辑器\",\"all\":\"同时使用\"}},\"fileMaxSize\":{\"title\":\"最大上传限制(M)\",\"type\":\"text\",\"value\":\"10\",\"tips\":\"\"},\"timeout\":{\"title\":\"超时时间\",\"type\":\"text\",\"value\":\"30000\",\"tips\":\"\"}}');
INSERT INTO `[#DB_PREFIX#]plugins` (`name`, `title`, `intro`, `author`, `version`, `state`, `config`) VALUES ('mobile_editor', '移动端编辑器', '', 'WeCenter官方', '3.6.2', 2, '[]');
INSERT INTO `[#DB_PREFIX#]hook_plugins` (`hook`, `plugins`, `add_time`, `update_time`, `sort`, `status`) VALUES ('editor', 'editor', 0, 0, 0, 1);
INSERT INTO `[#DB_PREFIX#]hook_plugins` (`hook`, `plugins`, `add_time`, `update_time`, `sort`, `status`) VALUES ('mobile_editor', 'mobile_editor', 0, 0, 0, 1);
